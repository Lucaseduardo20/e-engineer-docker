# Task 11 — Criar experiência de Criação Assistida de Projeto
...
Unificar as peças anteriores em uma experiência de criação de projeto guiada e vendável.

---

# Contexto específico

O usuário deve informar contexto técnico, receber sugestões e escolher se quer começar do zero ou usar projeto existente como base.

---

# Escopo funcional

Criar/refatorar modal/tela de Novo Projeto como wizard: dados básicos, tags, projetos semelhantes, ponto de partida, revisão de entregáveis, confirmação. MVP pode ser dados+tags, sugestões e criar.

---

# Backend — O que deve ser feito

Reaproveitar endpoints: project tags, recommend similar projects, create from base, inherit deliverables. Criar pequenos endpoints de preview só se necessário.

---

# Frontend — O que deve ser feito

Implementar wizard com TechnicalTagSelector, cards de semelhantes, Começar do zero, Usar como base, seleção de entregáveis, resumo antes de criar, redirecionamento ao cockpit.

---

# Regras de negócio

Usuário sempre pode começar do zero. Sugestões não bloqueiam. Não expor score/relationType. UX rápida e clara. Permissões respeitadas.
...
- Novo projeto usa criação assistida
- Seleciona tags governadas
- Semelhantes aparecem
- Começar do zero funciona
- Usar como base funciona
...
- Criar do zero com tags.
- Ver semelhantes ao selecionar tags.
- Usar como base.
- Sem sugestões ainda permite criar.
- Usuário entende sem explicação externa.
